...
#define K_SPLASH_URL_DEFAULT @"http://nosna.net/ipad/imagens.php?%d"
#define K_SPLASH_URL_PATROCINIO @"http://ads.globo.com/RealMedia/ads/adstream_sx.ads/ogcapp/vairio/capa/%d@x01"
